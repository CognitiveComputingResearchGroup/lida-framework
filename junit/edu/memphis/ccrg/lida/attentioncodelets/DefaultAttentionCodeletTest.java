...
public class DefaultAttentionCodeletTest {
	...
	public void setUp() {
		...
		link12 = factory.getLink(node1, node2, PerceptualAssociativeMemoryImpl.NONE);
		link21 = factory.getLink(node2, node1, PerceptualAssociativeMemoryImpl.NONE);
		
		link32 = factory.getLink(node2, node3, PerceptualAssociativeMemoryImpl.NONE);
		link23 = factory.getLink(node3, node2, PerceptualAssociativeMemoryImpl.NONE);
	}
