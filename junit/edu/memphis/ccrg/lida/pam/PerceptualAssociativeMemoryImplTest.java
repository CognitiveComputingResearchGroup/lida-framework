...
public class PerceptualAssociativeMemoryImplTest {
	...
	public void testGetPamLink() {
		...
		ExtendedId id2 = new ExtendedId(node1.getId(), node2.getExtendedId(),
				PerceptualAssociativeMemoryImpl.DEFAULT_LINK_CATEGORY.getId());
	...
	public void testGetLinkCategory() {
		int id = PerceptualAssociativeMemoryImpl.DEFAULT_LINK_CATEGORY.getId();
		assertEquals(PerceptualAssociativeMemoryImpl.DEFAULT_LINK_CATEGORY, pam
				.getLinkCategory(id));
