...
public class FactoriesDataXmlLoaderTest {
	...
	public void testGetLinkables() {
		String xml = "<LidaFactories>"
				...
				+ "<param name=\"learnableActivatible.baseLevelDecayStrategy\" type=\"string\">slowDecay</param>"
				+ "<param name=\"learnableActivatible.baseLevelExciteStrategy\" type=\"string\">slowExcite</param>"
				+ "<param name=\"learnableActivatible.baseLevelRemovalThreshold\" type=\"double\">0.0</param>"
				+ "<param name=\"learnableActivatible.baseLevelActivation\" type=\"double\">0.1</param> "
		...
		assertEquals("slowDecay", def.getParams().get("learnableActivatible.baseLevelDecayStrategy"));
	...
	public void testGetLinkable() {
		String xml = "<node name=\"PamNodeImpl\">"
				...
				+ "<param name=\"learnableActivatible.baseLevelExciteStrategy\" type=\"string\">slowExcite</param>"
				+ "<param name=\"learnableActivatible.baseLevelRemovalThreshold\" type=\"double\">0.0</param>"
				+ "<param name=\"learnableActivatible.baseLevelActivation\" type=\"double\">0.1</param> </node>";
