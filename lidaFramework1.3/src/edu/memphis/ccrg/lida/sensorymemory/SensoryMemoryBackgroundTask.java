...
/**
 * Task which operates a Sensory Memory. This class provides a general way to
 * control various type of sensory memory -- It is the meaning of "background"
 * here.
 * 
...
public class SensoryMemoryBackgroundTask extends FrameworkTaskImpl {
	...
	private static final Logger logger = Logger
			.getLogger(SensoryMemoryBackgroundTask.class.getCanonicalName());
