...
public class NoBehaviorArrivingTrigger extends NoActionSelectionOccurringTrigger {
	...
	/**
	 * Every time a new behavior is added 'checkForTrigger' is called for each
	 * trigger. In the case of this trigger the 'reset()' method inherited from
	 * NoActionSelectionOcurringTrigger is called which reSets timer task
	 * object.
	 * 
