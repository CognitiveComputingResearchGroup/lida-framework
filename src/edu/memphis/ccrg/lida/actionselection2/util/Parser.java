...
import edu.memphis.ccrg.lida.actionselection2.engine.Behavior;
import edu.memphis.ccrg.lida.actionselection2.engine.BehaviorNetwork;
import edu.memphis.ccrg.lida.actionselection2.engine.Environment;
import edu.memphis.ccrg.lida.actionselection2.engine.Goal;
import edu.memphis.ccrg.lida.actionselection2.engine.ProtectedGoal;
import edu.memphis.ccrg.lida.actionselection2.engine.ReinforcementCurve;
import edu.memphis.ccrg.lida.actionselection2.engine.Reinforcer;
import edu.memphis.ccrg.lida.actionselection2.engine.SidneyCodelet;
import edu.memphis.ccrg.lida.actionselection2.engine.Stream;
 ...
 */    
    ...
    public BehaviorNetwork parse(String netFileName)
    {
        ...
        net = new BehaviorNetwork(environment, goals, streams);
