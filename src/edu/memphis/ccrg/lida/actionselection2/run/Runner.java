...
import edu.memphis.ccrg.lida.actionselection2.util.MultiMap;
import edu.memphis.ccrg.lida.actionselection2.util.Parser;
 ...
 */    
    ...
    {                
        ...
        CycleInformation cycleInfo = extractCycleInformation();        
        trace.add(cycleInfo);        
    ...
    {
        CycleInformation cycle = new CycleInformation((int)BehaviorNetwork.getCycle() - 1);
