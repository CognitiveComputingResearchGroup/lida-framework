 ...
 * @deprecated This may be removed in the future. Its functionality is subsumed
 *             by {@link NeighborhoodAttentionCodelet}.
 */
@Deprecated
public class BasicAttentionCodelet extends AttentionCodeletImpl {

	private static final Logger logger = Logger
			.getLogger(BasicAttentionCodelet.class.getCanonicalName());
