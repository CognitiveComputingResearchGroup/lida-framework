 ...
 */
public interface NodeStructure extends CognitiveContentStructure {
     ...
     *         present.
     */
    public Link addDefaultLink(Node source, Linkable sink, LinkCategory category,
     ...
     *         present.
     */
    public Link addDefaultLink(int idSource, ExtendedId idSink, LinkCategory type,
            double activation, double removalThreshold);
     ...
     *         present.
     */
    public Link addDefaultLink(int idSource, int idSink, LinkCategory type, double activation,
     ...
     *         present.
     */
    public Link addLink(String type, int srcId, ExtendedId snkId, LinkCategory cat, double a,
            double rt);
     ...
     *         present.
     */
    public Link addLink(String type, Node src, Linkable sink, LinkCategory cat, double a,
            double rt);
