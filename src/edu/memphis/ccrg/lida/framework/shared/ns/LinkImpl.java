...
public class LinkImpl extends ActivatibleImpl implements Link {
	...
	private static final Logger logger = Logger.getLogger(LinkImpl.class
			.getCanonicalName());
	 ...
	 * 
	 * @deprecated Use
	 *             {@link ElementFactory#getLink(Node, Linkable, LinkCategory)}
	 *             instead.
	 * @param src
	 *            source {@link Node}
	 * @param snk
	...
	/**
	 * This method compares this LinkImpl with any kind of Link. Two Links are
	 ...
	 * @see NodeStructureImpl#getNewLink(Link, String, Node, Linkable,
	 *      LinkCategory)
	 */
	@Override
