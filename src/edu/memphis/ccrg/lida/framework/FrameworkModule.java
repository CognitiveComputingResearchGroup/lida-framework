...
public interface FrameworkModule extends FullyInitializable {
	 ...
	 * 
	 * @param moduleName
	 *            {@link ModuleName} of this FrameworkModule
	 */
	 ...
	 * 
	 * @param name
	 *            {@link ModuleName} of submodule
	 * @return true if there is a {@link FrameworkModule} with specified
	 *         {@link ModuleName} in this {@link FrameworkModule}
	 */
	 ...
	 * @param name
	 *            {@link ModuleName} of submodule
	 * @return true if there is a {@link FrameworkModule} with specified name in
	...
	/**
	 * Returns module content specified by params. Intended for use by the GUI
	 * only.
	 * 
	 * @param params
	...
	/**
	 * Decay this module and all its submodules. Framework users should not call
	 * this method. It will be called by the TaskManager. Decays this module and
	 * all its submodules.
	 * 
	 * @param ticks
	...
	/**
	 * Decay the elements of this {@link FrameworkModule} only (not its
	 * submodules). Framework users should not call this method. It will be
	 * called by the {@link TaskManager}. However, specific
	 * {@link FrameworkModule} implementations may want to implement this
	 * method.
	 * 
	 * @param ticks
	 *            number of ticks to decay.
	...
	/**
	 * Specify the {@link TaskSpawner} which this FrameworkModule will use to
	 * spawn tasks.
	 * 
	 * @param ts
	 *            the TaskSpawner
	...
	/**
	 * Returns the {@link TaskSpawner} which this FrameworkModule uses to spawn
	 * tasks.
	 * 
