 ...
 * regions. Each region can contain one or more {@link LidaPanel}s specified by
...
public class LidaGui extends javax.swing.JFrame {
	...
	private static final Logger logger = Logger.getLogger(LidaGui.class
			.getCanonicalName());
	...
	/**
	 * Constructs a new LidaGui using the {@link Lida} object as the model and
	 * {@link LidaGuiController} as the controller. Reads the {@link Properties}
	 * file and creates and configures the {@link LidaPanel}s specified therein.
	 * 
	 * @param lida
	 *            {@link Lida} the model.
	 * @param controller
	 *            {@link LidaGuiController} the controller
	...
	public LidaGui(Lida lida, LidaGuiController controller,
		...
		if (lida == null || controller == null || panelProperties == null) {
			logger.log(Level.WARNING, "Null argument", LidaTaskManager
					.getCurrentTick());
		}
	 ...
	 * a new {@link LidaPanel} and initializes it.
	 * 
	 * @param panelParams
	...
	private void addToPanelsMenu(final LidaPanel panel, final Container parent, JMenu associatedMenu) {
		final JPanel jPanel = panel.getPanel();
		JMenu cMenu;
	...
	private void loadPanelSettingsMenuItemActionPerformed(java.awt.event.ActionEvent evt) {
		javax.swing.JFileChooser fc = new javax.swing.JFileChooser(
				new java.io.File(LidaStarter.DEFAULT_LIDA_PROPERTIES_PATH));
