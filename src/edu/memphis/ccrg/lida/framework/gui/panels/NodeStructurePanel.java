 ...
 * 
 * The {@link NodeStructure} is one from a paticular {@link FrameworkModule}
 * which is defined as a parameter in the guiPanels.properties file.
 * 
 * {@link FrameworkModule#getModuleContent(Object...)} must return
 * {@link NodeStructure}.
 * 
...
public class NodeStructurePanel extends GuiPanelImpl {
	...
	private static final Logger logger = Logger
			.getLogger(NodeStructurePanel.class.getCanonicalName());
	private NodeStructureGuiAdapter guiGraph = new NodeStructureGuiAdapter(
			new NodeStructureImpl());
	...
	private void draw() {
		...
		Layout<Linkable, GuiLink> layout = new FRLayout<Linkable, GuiLink>(
				guiGraph);
		...
		vizViewer.setPreferredSize(new Dimension(350, 350)); // Sets viewing
																// area size
		...
		vizViewer
				.setVertexToolTipTransformer(new Transformer<Linkable, String>() {
					...
					public String transform(final Linkable l) {
						...
						if (l instanceof Activatible) {
							if (l instanceof PamNode) {
								...
								tip = String
										.format(
												"<html><b>%s</b><br/>Activation: %06.4f</html>",
												n, n.getActivation());
							}
						}
						return tip;
		...
		vizViewer.setEdgeToolTipTransformer(new Transformer<GuiLink, String>() {
			...
			public String transform(final GuiLink l) {
				...
				Link n = gl.getLink();
				tip = String.format(
						"<html><b>%s</b><br/>Activation: %06.4f</html>", n, n
								.getActivation());
				return tip;
			}
		});
