...
public class AgentStarter {
	...
	/**
	 * Create and run a LIDA and a {@link FrameworkGuiFactory} using the properties object
	 */
	private static void run() {
		//Load factories data
		FactoriesDataXMLLoader lidaFactoriesLoader=new FactoriesDataXMLLoader();
		lidaFactoriesLoader.loadFactoriesData(lidaProperties);
		
		// Create model, LIDA
		Agent lida = new AgentXmlFactory().getLida(lidaProperties);
...
//        	manager.initDataAccessObjects(lida);
		...
		FrameworkGuiFactory.start(lida, lidaProperties);
	}
