...
//     * @param timer 
//     * @param pam */
//    public ControlPanelGui(ThreadSpawner start, ThreadSpawner codeletDriver, Environment e) {
//    	this.frameworkTimer = FrameworkTimer.getInstance();
//    	isPaused = frameworkTimer.getStartStatus();
//    	mainThread = start;
