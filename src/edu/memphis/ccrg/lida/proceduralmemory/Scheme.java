 ...
 * in the presence of its context. If its action is taken then its result is
 * more likely to be true. It can be instantiated in which case the
 * instantiation is called a {@link Behavior}.
 * 
...
public interface Scheme extends ProceduralUnit, Learnable {
	 ...
	 * 
	 * @param a
	 *            {@link Action} this unit contains
	 */
	 ...
	 * of times its action has been executed in order to calculate reliability.
	 */
	 ...
	 * Returns reliability
	 * 
	 * @return frequency that result is observed after scheme's {@link Action}
	 *         is taken.
	 */
	 ...
	 * 
	 * @param innate
	 *            whether this {@link Scheme} is hard-wired and cannot be
	 *            decayed.
	 */
