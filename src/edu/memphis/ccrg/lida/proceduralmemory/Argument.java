 ...
 * it can be used as part of a NodeStructure. It is mostly used for define Context and results for Schemes and SBC.
 * The Argument can be binded to a real Node. Then, the Argument works as a wrapper for the real Node and can be used 
