...
import edu.memphis.ccrg.lida.pam.tasks.ns.BasicDetectionAlgorithm;
 ...
 */
public interface PerceptualAssociativeMemoryNS extends PerceptualAssociativeMemory {

    /**
     * Adds a new {@link PamNode} of default type to PAM with specified label.
     * Label must be unique. If not, existing node with specified label is
     * returned.
     * 
     * @param label
     *            the label of the new {@link PamNode}
     * @return the new {@link PamNode} added to PAM, the existing Node with
     *         specified label or null
     */
    public PamNode addDefaultNode(String label);

    /**
     * Adds a new {@link PamNode} of specified type to PAM with specified label.
     * Type should refer to a subclass of {@link PamNodeImpl}. Label must be
     * unique. If not, existing node with specified label is returned.
     * 
     * @param type
     *            the type of the new {@link PamNode}
     * @param label
     *            the label of the new {@link PamNode}
     * @return the new {@link PamNode} added to PAM, the existing Node with
     *         specified label or null
    ...
    /**
     * Adds a new {@link PamLink} of default type to PAM. If a link with the
     * same attributes already exists the existing link will be returned
     * instead.
     * 
     * @param src
     *            the link's source
    ...
    /**
     * 
     * Adds a new {@link PamLink} of specified type to PAM. Type should refer to
     * a subclass of {@link PamLinkImpl}. If a link with the same attributes
     * already exists the existing link will be returned instead.
     * 
     * @param type
     *            link's type
     * @param src
    ...
    /**
     * Adds a COPY of specified node to this
     * {@link PerceptualAssociativeMemoryNS} . Node will be of Pam's default
     * type.
     * 
    ...
    /**
     * Adds a COPY of a collection of Nodes to this PAM. Nodes will be of Pam's
     * default type.
     * 
     * @deprecated Use either {@link #addNode(String, String)} or
     *             {@link #addDefaultNode(String)} instead.
    ...
    /**
     * Adds a COPY of specified link to this PAM. Link will be of Pam's default
     * type.
     * 
     * @deprecated Use either
     *             {@link #addLink(String, Node, Linkable, LinkCategory)} or
     *             {@link #addDefaultLink(Node, Linkable, LinkCategory)}
     *             instead.
     * @param link
     *            PamLink to add
    ...
    /**
     * Adds a COPY of specified collection of PamLinks to this PAM. Links will
     * be of Pam's default type.
     * 
     * @deprecated Use either
     *             {@link #addLink(String, Node, Linkable, LinkCategory)} or
     *             {@link #addDefaultLink(Node, Linkable, LinkCategory)}
    ...
    /**
     * Sets {@link PropagationStrategy} governing how activation is propagated
     * in this PAM.
     * 
     * @param strategy
     *            {@link PropagationStrategy}
     */
    public void setPropagationStrategy(PropagationStrategy strategy);

    /**
     * Gets {@link PropagationStrategy} governing how activation is propagated
     * in this PAM.
     * 
     ...
     * 
     * @param linkable
     *            Id of the PamLinkable receiving the activation
     * @param amount
     *            amount of activation to excite
     ...
     * 
     * @param linkables
     *            Ids of PamLinkable to be excited
     * @param amount
     ...
     * 
     * @param pamNode
     *            The {@link PamNode} to propagate activation from.
     * @see ExcitationTask
     * @see PropagationTask
     */
    ...
    /**
     * Adds a COPY of specified LinkCategory to this
     * {@link PerceptualAssociativeMemoryNS}. Category must also be a node in
     * order to be added. Node will be of Pam's default type.
     * 
     * @param cat
     *            {@link LinkCategory}
     ...
     * 
     * @param t
     *            threshold for a {@link Linkable} to become part of the percept
     */
     ...
     * 
     * @param id
     *            sought {@link ExtendedId}
     * @return PamNode the actual Node
     */
    public Node getNode(ExtendedId id);

    /**
     * Returns the {@link PamNode} with specified label or null. This method is
    ...
    /**
     * Returns an unmodifiable collection of the {@link PamNode}s in this PAM as
     * {@link Node}s.
     * 
    ...
    /**
     * Returns an unmodifiable collection of the {@link PamLink}s in this PAM as
     * {@link Link}s.
     * 
