...
public class PamLinkImpl extends LinkImpl implements PamLink {
	 ...
	 *      edu.memphis.ccrg.lida.framework.shared.ns.Node,
	 *      edu.memphis.ccrg.lida.framework.shared.ns.Linkable,
	 *      edu.memphis.ccrg.lida.framework.shared.ns.LinkCategory, String, String,
	 *      double, double)
	 */
	@Override
	public void init() {
