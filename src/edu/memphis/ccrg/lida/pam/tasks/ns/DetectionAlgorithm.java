...
/**
 * A process which detects a pattern (feature) in {@link SensoryMemory} content
 * and excites {@link PamNode}s representing that pattern.
 * 
...
public interface DetectionAlgorithm extends FrameworkTask {
	 ...
	 * Detects a feature.
	 * 
	 * @return value from 0.0 to 1.0 representing the degree to which the
	 *         feature occurs.
	 */
