 ...
 */
public class EpisodicMemoryImpl extends LidaModuleImpl implements EpisodicMemory, BroadcastListener, CueListener {

	private static final Logger logger = Logger.getLogger(EpisodicMemoryImpl.class.getCanonicalName());
	 ...
	 * In this implementation, first the cue is translated to a BitVector. @see {@link Translator}
	 * 
   ...
   return;
	...
	public void init() {
		...
		int radious = (Integer)getParam("tem.activationRadious",DEF_ACTIVATION_RADIUS);
