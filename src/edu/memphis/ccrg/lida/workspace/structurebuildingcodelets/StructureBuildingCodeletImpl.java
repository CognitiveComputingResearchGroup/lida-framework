 ...
 * 
 */
public abstract class StructureBuildingCodeletImpl extends CodeletImpl
		implements StructureBuildingCodelet {

	private static final Logger logger = Logger
			.getLogger(StructureBuildingCodeletImpl.class.getCanonicalName());
	...
	public void setAssociatedModule(FrameworkModule module, String usage) {
		if (module instanceof WorkspaceBuffer) {
			...
			logger
					.log(
							Level.WARNING,
							"Expected module to be a WorkspaceBuffer but it was not.  Module not added.",
							TaskManager.getCurrentTick());
		}
	}
